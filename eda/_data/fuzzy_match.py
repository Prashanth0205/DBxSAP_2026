...
HERE = Path(__file__).resolve().parent           # eda/_data
EDA = HERE.parent                                # eda
...
def load_state_aliases() -> dict[str, str]:
    ...
    aliases_path = EDA / "state_aliases.csv"
    out: dict[str, str] = {}
...
def main() -> None:
    ...
    cand_path = EDA / "district_alias_candidates.csv"
    ...
    aliases_path = EDA / "district_aliases_auto.csv"
