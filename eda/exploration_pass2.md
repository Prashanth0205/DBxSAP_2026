...
The four supporting CSVs sit alongside this file:

- [`capability_keyword_expansion.csv`](capability_keyword_expansion.csv)
- [`category_distribution_by_capability.csv`](category_distribution_by_capability.csv)
- [`nfhs_indicator_stats.csv`](nfhs_indicator_stats.csv)
- [`facility_outcome_correlations.csv`](facility_outcome_correlations.csv)
- [`data_quality_outliers.csv`](data_quality_outliers.csv)
...
Run against the same 9,956 facilities the production app queries (after the `address_zipOrPostcode IS NOT NULL AND NOT IN ('', 'null')` filter). Source CSV: [`capability_keyword_expansion.csv`](capability_keyword_expansion.csv).
...
Source CSV: [`category_distribution_by_capability.csv`](category_distribution_by_capability.csv).
...
Source CSV: [`facility_outcome_correlations.csv`](facility_outcome_correlations.csv).
...
Source CSV: [`nfhs_indicator_stats.csv`](nfhs_indicator_stats.csv).
...
Source CSV: [`data_quality_outliers.csv`](data_quality_outliers.csv).
...
- The 5-category distribution and correlation results are reproducible via `python3 eda/_data/category_distribution.py` (writes the SQL it ran to `eda/_data/category_distribution_query.sql` and the bucket counts to `eda/category_distribution_by_capability.csv`).
